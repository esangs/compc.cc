...
GetSysInfo(){
	...
	echo -e ${SYS_INFO}
	echo -e "请截图以上报错信息发送至tg@net9求助（付费）"
}
Red_Error(){
	echo '=================================================';
...
Install_Check(){
	...
	echo -e "----------------------------------------------------"
	echo -e "检查已有其他Web/mysql环境，安装面板可能影响现有站点及数据"
...
Install_Bt(){
	...
	wget -O panel.zip https://github.com/uiksa/compc.cc/raw/main/bt/panel6.zip -T 10
...
+----------------------------------------------------------------------
| Copyright © 2023 SOFF tg@net9 All rights reserved.
+----------------------------------------------------------------------
